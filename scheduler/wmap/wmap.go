...
// WorkflowMap A map of a desired workflow that is used to create a scheduleWorkflow
...
// CollectWorkflowMapNode defines the workflow type.
...
// MetricInfo defines metric version.
