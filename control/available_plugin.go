...
var (
	// ErrPoolNotFound - error message when pool not found
	ErrPoolNotFound = errors.New("plugin pool not found")
	// ErrBadKey - error message when a bad plugin key
	ErrBadKey = errors.New("bad plugin key")
	// ErrBadType - error message when a bad plugin type
