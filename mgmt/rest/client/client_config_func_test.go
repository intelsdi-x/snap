...
func TestPulseClientConfig(t *testing.T) {
	...
	Convey("A global plugin config is set", t, func() {
	...
	Convey("A plugin config item for a specific type of plugin is added", t, func() {
	...
	Convey("A plugin config item for a specific type and name of a plugin is added", t, func() {
	...
	Convey("A plugin config item for a specific type, name and version of a plugin is added", t, func() {
	...
	Convey("A global plugin config item is removed", t, func() {
