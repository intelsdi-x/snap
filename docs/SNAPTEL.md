...
[snap-cli](https://github.com/intelsdi-x/snap-cli).
    ...
    The Snap API client can be autogenerated based on provided [swagger.json](https://github.com/intelsdi-x/snap/swagger.json) in different
languages/frameworks supported by [swagger-code-generator](https://github.com/swagger-api/swagger-codegen#swagger-code-generator) - follow
the instruction provided there to generated Snap API client in your preferred language.
